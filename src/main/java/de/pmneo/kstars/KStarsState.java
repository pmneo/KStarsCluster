...
public class KStarsState extends WithLogging {
    ...
    /** Captured-image/HFR/guide-error/timeline-event history, and resolving a recorded filename
     *  back to a real file — see SessionHistory's own javadoc for why this is a separate class. */
    ...
    public GuideStatus handleGuideStatus( GuideStatus state ) {
        ...
        history.recordTimelineEvent( "guide", state.name() );
    ...
    public MountStatus handleMountStatus( MountStatus state ) {
        ...
        history.recordTimelineEvent( "mount", state.name() );
    ...
    public AlignState handleAlignStatus( AlignState state ) {
        ...
        history.recordTimelineEvent( "align", state.name() );
        return state;
    }
