...
public class CommandServlet extends HttpServlet
{
    ...
    /** Polled continuously by the UI (status WS fallback) — logging every call would drown out actual commands. */
    private static final Set<String> QUIET_ACTIONS = Set.of( "status" );
